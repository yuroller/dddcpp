...
#if defined(__has_include)
#  if __has_include("optional.hpp") && defined(CATCH_CPP17_OR_GREATER)
#    define CATCH_INTERNAL_CONFIG_CPP17_OPTIONAL
#  endif // __has_include("optional.hpp") && defined(CATCH_CPP17_OR_GREATER)
#endif // __has_include
...
namespace Catch {
    ...
    struct StringMaker<tl::optional<T> > {
        static std::string convert(const tl::optional<T>& optional) {
            ReusableStringStream rss;
...
#ifdef __has_include
#if __has_include("optional.hpp") && __cplusplus >= 201703L
#include "optional.hpp"
#define CLARA_CONFIG_OPTIONAL_TYPE tl::optional
#endif
#endif
#endif
